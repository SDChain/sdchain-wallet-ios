...
- (NSDictionary *)sortedArrayUsingFirstLetter
{
    ...
    for (NSString *str in self) {
        ...
        //Check if str is an NSString type
        ...
        //Read first character if it is not uppercase or lowercase
        if (!(*letterPoint > 'a' && *letterPoint < 'z') &&
            !(*letterPoint > 'A' && *letterPoint < 'Z')) {
            //Chinese characters or other characters
        ...
        //List of names corresponding to the first letter
    ...
    //The dictionary is unordered, the array is ordered,
    //Sort arrays
