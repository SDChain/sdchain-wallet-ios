...
@property(nonatomic,strong)NSString *friendUserName;   //username
@property(nonatomic,strong)NSString *friendRealName;   //actual name
@property(nonatomic,strong)NSString *friendNickName;   //nickname
@property(nonatomic,strong)NSString *friendAccount;    //Default wallet
@property(nonatomic,strong)NSString *mobile;           //Mobile phone
@property(nonatomic,strong)NSString *email;            //mailbox
@property(nonatomic,strong)NSString *isFriend;         //Whether or not
